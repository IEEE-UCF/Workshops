 ...
 *  an integer called "level" to equal 1
 *  an integer called "velocity" to equal 100
 */
_____________;
___________________;
...
void setup() {
  ...
  /*
   * Step 2
   * Use pinMode to declare pin 4 and 5 as OUTPUTs
   */
  __________________;
  __________________;
  ...
  /*
  * Step 3
  * Use digitalWrite to write LOW voltages to pins 4 and 5
  */
...
void loop()
{
  /*
   * Step 4
   * Write an if-statement that reads whether or not level is equal to 1
   */
  _______________ 
  if (level == 1)
